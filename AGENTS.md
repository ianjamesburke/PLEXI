...
- `alpha` — active development. **All v2 progress lands here first.** Feature branches are cut from alpha, worked in `.Codex/worktrees/` subdirectories, merged back via PR.
