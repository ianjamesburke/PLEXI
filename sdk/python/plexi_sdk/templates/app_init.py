...
Dev loop: `plexi app open .` (hot reload) · `plexi app check .` (validate)
UI API: read `plexi_sdk/ui.py` | Canvas/on_render API: read `docs/sdk-v2.md` | Publish: uncomment [marketplace] in manifest.toml
"""
