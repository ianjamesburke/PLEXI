...
- [SDK_QUICKSTART.md](SDK_QUICKSTART.md) — end-to-end tutorial: init, dev, verify, publish.
- [SDK_V2.md](SDK_V2.md) — full API reference: lifecycle hooks, state, I/O, canvas drawing, layout components.
