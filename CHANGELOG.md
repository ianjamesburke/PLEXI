...
### Changes
- fix(ci): install libasound2-dev for check-cli-docs and check-protocol workflows
- fix(navigation): push focus history before pane creation changes focus (#1306)
- fix(quick-note): log substituted command + warn on quoted tokens (#1304)
- feat(finder): restore macOS Finder 'Open in Plexi' service (#690) (#1301)
- fix(panes): new panes/tabs use context root directory (#1299) (#1300)
- fix(ship-issue): auto-stash dirty alpha instead of blocking pipeline
