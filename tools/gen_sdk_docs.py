...
def generate() -> str:
    ...
    out.append("")
    out.append("The Python SDK and local app runtime are part of stable v1. MCP client APIs listed below are beta-gated; do not rely on them from a stable channel.")
    out.append("")
