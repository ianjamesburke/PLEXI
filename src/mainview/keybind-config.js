...
const APP_KEYBIND_SPECS = isMacOS
  ? [
    ...
    "super+9=pane_9",
    "ctrl+9=pane_9",
    "super+shift+1=context_1",
    "ctrl+shift+1=context_1",
    "super+shift+2=context_2",
    "ctrl+shift+2=context_2",
    "super+shift+3=context_3",
    "ctrl+shift+3=context_3",
    "super+shift+4=context_4",
    "ctrl+shift+4=context_4",
    "super+shift+5=context_5",
    "ctrl+shift+5=context_5",
    "super+shift+6=context_6",
    "ctrl+shift+6=context_6",
    "super+shift+7=context_7",
    "ctrl+shift+7=context_7",
    "super+shift+8=context_8",
    "ctrl+shift+8=context_8",
    "super+shift+9=context_9",
    "ctrl+shift+9=context_9",
  ]
  : [
    "ctrl+n=new_node_right",
    "ctrl+shift+n=new_node_down",
