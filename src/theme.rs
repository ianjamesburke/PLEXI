...
impl Colors {
    pub fn from_config(cfg: &ThemeConfig) -> Self {
        Self {
            ...
            list_item_hover: parse_hex_or(&cfg.list_item_hover, Color32::from_rgb(0x2e, 0x2e, 0x42)),
...
pub fn apply_preset(preset: &ThemeConfig, user: &ThemeConfig) -> ThemeConfig {
    ...
    ThemeConfig {
        ...
        list_item_hover: m(&user.list_item_hover, &preset.list_item_hover),
