...
pub fn random_command(rng: &mut SplitMix64, doc: &Document) -> EditorCommand {
    match rng.below(100) {
        ...
        44..=49 => EditorCommand::Backspace,
        50..=53 => EditorCommand::DeleteForward,
        54..=56 => EditorCommand::DeleteWordBackward,
        57..=59 => EditorCommand::DeleteWordForward,
        60 => EditorCommand::KillToLineStart,
        61 => EditorCommand::KillToLineEnd,
        62..=66 => EditorCommand::SetCursor(random_cursor(rng, doc)),
        67..=69 => EditorCommand::ExtendTo(random_cursor(rng, doc)),
        70 => EditorCommand::SelectAll,
        71 => EditorCommand::SelectWordAt(random_cursor(rng, doc)),
        72 => EditorCommand::SelectLineAt(rng.below(doc.buffer().line_count() as u64 + 2) as usize),
        73 => EditorCommand::Indent,
        74 => EditorCommand::Outdent,
        75 => EditorCommand::MarkdownIndent,
        76 => EditorCommand::MarkdownOutdent,
        77..=78 => EditorCommand::MarkdownNewline,
        79..=80 => EditorCommand::MarkdownBackspace,
        81 => EditorCommand::InsertNewline,
        82..=88 => EditorCommand::Undo,
        89..=94 => EditorCommand::Redo,
        95..=97 => EditorCommand::ImePreedit(
            INSERT_POOL[rng.below(INSERT_POOL.len() as u64) as usize].to_string(),
        ),
        98 => EditorCommand::ImeCommit(
            INSERT_POOL[rng.below(INSERT_POOL.len() as u64) as usize].to_string(),
        ),
        99 => EditorCommand::ImeCancel,
