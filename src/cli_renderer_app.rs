...
use crate::plexi_descriptor::{ArgSpec, ArgType, Command, PlexiDescriptor};
use crate::style;
...
impl CliRendererApp {
    ...
    fn render_list(&mut self, ui: &mut egui::Ui, colors: &crate::theme::Colors) {
    ...
    fn render_form(&mut self, ui: &mut egui::Ui, colors: &crate::theme::Colors) {
    ...
    fn render_field(&mut self, ui: &mut egui::Ui, colors: &crate::theme::Colors, arg: &ArgSpec) {
        ui.horizontal(|ui| {
            ui.add_space(style::SPACE_MD);
            ui.vertical(|ui| {
                // Label
