...
pub(crate) fn file_icon_kind(entry: &Entry) -> FileIconKind {
    ...
    match ext.as_str() {
        ...
        | "cpp" | "hpp" | "sh" | "zsh" | "bash" | "fish" | "lua" | "rb" => FileIconKind::Code,
        "toml" | "yaml" | "yml" | "json" | "jsonc" | "json5" | "ini" | "cfg" | "conf" | "env"
        | "plist" => FileIconKind::Config,
...
pub(crate) fn paint_entry_icon(
    ...
    if entry.is_dir {
        ...
        painter.rect_filled(
            body,
            CornerRadius::same(2),
            colors.accent.gamma_multiply(0.9),
        );
        return;
    }
    ...
    painter.rect_filled(
        sheet,
        CornerRadius::same(2),
        colors.text_dim.gamma_multiply(0.34),
    );
    painter.rect_stroke(
        sheet,
        CornerRadius::same(2),
    ...
    match kind {
        ...
        FileIconKind::Audio => {
            ...
            painter.add(egui::Shape::convex_polygon(
                vec![
                    ...
                    egui::pos2(x(0.36), y(0.40)),
                    egui::pos2(x(0.47), y(0.40)),
                    egui::pos2(x(0.47), y(0.68)),
            ...
            painter.line_segment(
                [egui::pos2(x(0.56), y(0.64)), egui::pos2(x(0.66), y(0.54))],
                Stroke::new(stroke_w, c),
            );
            painter.line_segment(
                [egui::pos2(x(0.68), y(0.38)), egui::pos2(x(0.80), y(0.54))],
                Stroke::new(stroke_w, c.gamma_multiply(0.9)),
            );
            painter.line_segment(
                [egui::pos2(x(0.68), y(0.70)), egui::pos2(x(0.80), y(0.54))],
                Stroke::new(stroke_w, c.gamma_multiply(0.9)),
            );
        }
        FileIconKind::Markdown | FileIconKind::Text => {
            ...
            painter.add(egui::Shape::convex_polygon(
                vec![
                    egui::pos2(x(0.70), y(0.26)),
                    egui::pos2(x(0.80), y(0.20)),
            ...
            if matches!(kind, FileIconKind::Markdown) {
                painter.line_segment(
                    [egui::pos2(x(0.26), y(0.26)), egui::pos2(x(0.54), y(0.26))],
                    Stroke::new(stroke_w, c.gamma_multiply(0.95)),
                );
            }
        }
        FileIconKind::Code => {
            ...
            painter.line_segment(
                [egui::pos2(x(0.24), y(0.52)), egui::pos2(x(0.38), y(0.70))],
                Stroke::new(stroke_w, c),
            );
            painter.line_segment(
                [egui::pos2(x(0.62), y(0.34)), egui::pos2(x(0.76), y(0.52))],
                Stroke::new(stroke_w, c),
            );
            painter.line_segment(
                [egui::pos2(x(0.76), y(0.52)), egui::pos2(x(0.62), y(0.70))],
                Stroke::new(stroke_w, c),
            );
            painter.line_segment(
                [egui::pos2(x(0.52), y(0.34)), egui::pos2(x(0.46), y(0.70))],
                Stroke::new(stroke_w * 0.9, c.gamma_multiply(0.85)),
            );
        }
        FileIconKind::Config => {
            ...
            painter.line_segment(
                [egui::pos2(x(0.22), y(0.56)), egui::pos2(x(0.78), y(0.56))],
                Stroke::new(stroke_w, c),
            );
        ...
        FileIconKind::Generic => {
            ...
            painter.line_segment(
                [egui::pos2(x(0.24), y(0.58)), egui::pos2(x(0.60), y(0.58))],
                Stroke::new(stroke_w, c),
            );
        }
    }
